...
def draw_formulaic_curve(draw: ImageDraw, x_nodes: int, y_nodes: int, x_node: int, y_node: int):
    ...
    if pair_type == "same":
        ...
        draw.ellipse((cx-r, cy-r, cx+r, cy+r), outline="white", width=line_width)
        ...
        draw.ellipse((cx-x_spacing, cy-y_spacing, cx+x_spacing, cy+y_spacing), outline="white", width=line_width)
