...
parser.add_argument("--color", type=str, help="color type (discrete, grayscale, rainbow, rainbow2, rainbow3, rainbow_distant, prism)")
parser.add_argument("--curve", type=str, default="bezier", help="curve type (bezier, bezier_centered, line, formulaic)")
